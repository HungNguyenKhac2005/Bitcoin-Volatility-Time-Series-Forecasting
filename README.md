...
│
├── images/                           # Thư mục lưu trữ hình ảnh minh họa, báo cáo, video demo và PDF
│   ├── AI Risk Control Engine _ Binance Style and 8 more pages - School - Microsoft​ Edge 2026-05-13 15-14-58.mp4
...
Sơ đồ kiến trúc chi tiết của dự án được mô tả đầy đủ trong file tài liệu PDF sau đây:

👉 **[Xem / Tải xuống Sơ đồ Kiến trúc Dự án (PDF)](images/Bitcoin-Volatility-Time-Series-Forecasting.pdf)** *(Xem cục bộ trên máy: [Bitcoin-Volatility-Time-Series-Forecasting.pdf](file:///C:/Python/Data_Science_Atifficial_Interligent/project_datascience%20_AI/Data_Analsys/Building_a_Hybrid_Machine_Learning_Model_for_Bitcoin_Volatility_Prediction_in_the_Global_Crypto_Market%20-%20Copy/images/Bitcoin-Volatility-Time-Series-Forecasting.pdf))*
...
- **Thư viện chính:**
  ...
  - *Trực quan hóa đồ thị:* `matplotlib`, `seaborn`, `plotly`
  - *Học sâu & Thống kê:* `PyTorch` (`torch`), `arch` (cho mô hình GARCH)
  - *Ứng dụng Web Dashboard:* `Streamlit`, `joblib`, `pickle`, `os`
...
* **Đặc trưng chính:**
  ...
  - *Lưu ý:* API cũng hỗ trợ thêm dữ liệu về phân loại (`CFGI_classification`) và thời gian (`CFGI_timestamp`), nhưng trong mô hình hiện tại dự án chỉ sử dụng thuộc tính chính là `CFGI`.
...
<p align="center">
  <video width="100%" controls>
    <source src="images/AI%20Risk%20Control%20Engine%20_%20Binance%20Style%20and%208%20more%20pages%20-%20School%20-%20Microsoft%E2%80%8B%20Edge%202026-05-13%2015-14-58.mp4" type="video/mp4">
    Trình duyệt của bạn không hỗ trợ thẻ phát video.
  </video>
</p>
<p align="center">
  <em>Xem video demo cục bộ chất lượng cao trên máy tại: <a href="file:///C:/Python/Data_Science_Atifficial_Interligent/project_datascience%20_AI/Data_Analsys/Building_a_Hybrid_Machine_Learning_Model_for_Bitcoin_Volatility_Prediction_in_the_Global_Crypto_Market%20-%20Copy/images/AI%20Risk%20Control%20Engine%20_%20Binance%20Style%20and%208%20more%20pages%20-%20School%20-%20Microsoft%E2%80%8B%20Edge%202026-05-13%2015-14-58.mp4">AI Risk Control Engine _ Binance Style and 8 more pages - School - Microsoft​ Edge 2026-05-13 15-14-58.mp4</a></em>
</p>
